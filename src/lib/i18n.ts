...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'sessions.noRecordings': 'No session recordings found',
    'sessions.noRecordingsHint': 'Use mur session start to begin recording',
  ...
  'zh-TW': {
    ...
    'sessions.date': '日期',
    'sessions.review': '檢視 →',
    'sessions.noRecordings': '找不到會話錄製',
    'sessions.noRecordingsHint': '使用 mur session start 開始錄製',
  ...
  'zh-CN': {
    ...
    'sessions.date': '日期',
    'sessions.review': '查看 →',
    'sessions.noRecordings': '未找到会话录制',
    'sessions.noRecordingsHint': '使用 mur session start 开始录制',
